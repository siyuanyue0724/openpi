            ...
            if action_chunk_target is not None:
                ...
                if self._supports_action_generation():
                    ...
                    for source_key, debug_key in (
                        ...
                        ("picf_action_context_token_aux_enabled", "pi_context_token_aux_enabled"),
                        ("picf_action_context_token_aux_loss", "pi_context_token_aux_loss"),
                        ("picf_action_context_token_aux_accuracy", "pi_context_token_aux_accuracy"),
                        ("picf_action_context_token_aux_weighted_total", "pi_context_token_aux_weighted_total"),
                        ("picf_action_context_token_aux_weight", "pi_context_token_aux_weight"),
                        ("picf_action_context_token_aux_bins", "pi_context_token_aux_bins"),
                        ("picf_action_context_token_aux_clip", "pi_context_token_aux_clip"),
                        ("picf_action_context_token_aux_token_count", "pi_context_token_aux_token_count"),
                        (
