...
def init_data(
    ...
    if data.lower() == "imagenet":
        from picf_next._vendor.vjepa2_ac.datasets.imagenet1k import make_imagenet1k
        ...
        from picf_next._vendor.vjepa2_ac.datasets.video_dataset import make_videodataset
