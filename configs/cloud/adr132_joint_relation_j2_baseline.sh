...
# The frozen K1 invocation evaluates released weights at step zero before its
# single update. Its evaluation plan is the immutable reference of J2's K8
# plan, so the candidate must replay this snapshot before its first update.
