...
EXP=${EXP:-picf_a7_object_owner_only_pull_probe_1000_20260519}
...
echo "[run] object-owner-only pull probe: no effector/contact graph owners, tactile attaches to role-1 object owner"
