    ...
    *,
    ...
    return {
        ...
        "observation": {
            ...
            "support_signature": _tensor_to_list(getattr(observation_anchors, "support_signature", None), max_rows=128),
            "binding_signature": _tensor_to_list(getattr(observation_anchors, "binding_signature", None), max_rows=128),
        ...
        "posterior": {
            ...
            "visual_signature": _tensor_to_list(getattr(posterior, "visual_signature", None), max_rows=128),
            "temporal_signature": _tensor_to_list(getattr(posterior, "temporal_signature", None), max_rows=128),
            "point_signature": _tensor_to_list(getattr(posterior, "point_signature", None), max_rows=128),
            "pg_signature": _tensor_to_list(getattr(posterior, "pg_signature", None), max_rows=128),
            "tactile_signature": _tensor_to_list(getattr(posterior, "tactile_signature", None), max_rows=128),
            "tracklet_signature": _tensor_to_list(getattr(posterior, "tracklet_signature", None), max_rows=128),
            "proposal_signature": _tensor_to_list(getattr(posterior, "proposal_signature", None), max_rows=128),
            "support_signature": _tensor_to_list(getattr(posterior, "support_signature", None), max_rows=128),
            "binding_signature": _tensor_to_list(getattr(posterior, "binding_signature", None), max_rows=128),
        },
        "task": {
