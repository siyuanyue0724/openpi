...
# E5 action-interface diagnostic.
#
# E3/E4 showed that PICF structure improves while action does not.  This run
# keeps the stable gated PI prefix recipe and appends a small, RMS-normalized,
# stop-gradient slice of conditioned-control context tokens to the PI0.5 action
# prefix.  It tests whether compressed-prefix information loss is the remaining
# action-transfer bottleneck.
...
export EXP="${EXP:-picf_a7_stepindexed_from9000_actioncontext_9300_20260530}"
