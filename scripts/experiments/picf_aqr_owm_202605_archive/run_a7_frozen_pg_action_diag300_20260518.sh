...
EXP="${EXP:-picf_a7_frozen_pg_action_diag300_20260518}"
...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0}" /root/openpi/.venv/bin/python -m torch.distributed.run --standalone --nproc_per_node=1 scripts/picf_core_train.py \
