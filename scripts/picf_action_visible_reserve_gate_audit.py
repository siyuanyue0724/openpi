    ...
    return [
        ...
        Check(
            ...
            _contains(
                ...
                "graph_weight_for_bias",
                "graph_bias = torch.log(torch.clamp(graph_weight_for_bias",
            ...
            "AQR graph anchors must use active/context/reserve downstream weights as action-prefix attention priors without destroying token content.",
        ),
        Check(
